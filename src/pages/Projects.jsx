...
function Projects() {
    ...
    return (
        <>
            {isLoading && <Loading color="tomato" />}
            {loaded && (
                <>
                    <HexagonBackground
                        image="hexagons/hexagon_projects.svg"
                        opacity={1}
                    />
                        ...
                        <section className="hero projects">
                            <article className="mainCaption">
                                ...
                                <p className="caption projects">
                                    ...
                                    were made for the purposes of school, while
                                    others were simply passion projects in which
                                    I pushed myself to my limits. Feel free to
                                    check them out!
                                </p>
                            </article>
                        ...
                        <section className="starred">
                            ...
                            <ScrollAnimation animateIn="animate__animated animate__bounceIn">
                                <Section
                                    ...
                                    color="tomato"
                                    text={
                                        'Originally created for a game jam using the Pygame module in Python, this game combines the popular memory card party game with the gameplay of a "Bullet Hell" game. The goal of the game is to flip over all of the pairs of cards while dodging incoming bullets. The game features three difficulties with randomized cards every playthrough. All graphics and UI were designed from scratch in Adobe Photoshop.'
                                    }
                                    width="25vw"
                                    title="Match Dodge"
                                    buttons={[
                                        {
                                            text: "Click here for a Gameplay Demonstration!",
